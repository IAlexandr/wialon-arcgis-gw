        ...
        async.parallel({
          addFoo: (callback) => {
            _this.FS.add(addList, (err, addResults) => {
              ...
              console.log('(FS.add) addResults:', addResults);
              return callback(null, addResults);
            });
          },
          updateFoo: (callback) => {
            _this.FS.update(updateList, (err, updateResults) => {
              ...
              console.log('(FS.update) updateResults:', updateResults);
          ...
          console.log('(timeInterval/async.parallel) results:', JSON.stringify(results, null, 2));
          _this.bucket = [];
        });
      }
    });
